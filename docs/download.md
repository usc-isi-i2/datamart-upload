...
| `admin3`              | string       | o  | O    | Third-level administrative country subdivision, such as municipalities in USA and woredas in Ethiopia <br/>__*Example value*__ Goba |
...
| Column Name           | Type         | Up | Down | Description | Examples |
|-----------------------|--------------|:--:|:----:|-------------|----------|
| `qualifier_source`    | string       | o  | O    | Column for the source qualifier  | CSA |
| `qualifier_source_id` | string       | o  | o    | Identifier for source qualifier  | [Q190360](https://www.wikidata.org/wiki/Q190360) |

## Upload Examples

Upload country-level population data by year.

| variable   | value       | time                | country  | coordinate          |
|------------|-------------|---------------------|----------|---------------------|
| Population | 100,000,000 | 2018-01-01T00:00:00 | Ethiopia | POINT(9.15 40.79)   |
| Population | 109,000,000 | 2019-01-01T00:00:00 | Ethiopia | POINT(9.15 40.79)   |
| Population | 320,000,000 | 2018-01-01T00:00:00 | USA      | POINT(37.09 -95.71) |
| Population | 328,000,000 | 2019-01-01T00:00:00 | USA      | POINT(37.09 -95.71) |

Upload admin1-level (region-level) food production data.

| variable    | main_subject | value | time                | country   | admin1  | qualifier_source |
|-------------|--------------|-------|---------------------|-----------|---------|------------------|
| Production  | maize        | 1.182 | 2016-01-01T00:00:00 | Ethiopia  | Oromia  | CSA              |
| Production  | teff         | 2.345 | 2016-01-01T00:00:00 | Ethiopia  | Oromia  | CSA              |


## Example CSV files

Download original food production data.
